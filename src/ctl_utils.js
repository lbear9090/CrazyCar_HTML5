...
function sizeHandler() {
    ...
    if(s_bIsIphone){
        ...
        controller.game.canvas.width = destW*2;
        controller.game.canvas.height = destH*2;
        canvas.style.width = destW+"px";
        canvas.style.height = destH+"px";
        var iScale = Math.min(destW / CANVAS_WIDTH, destH / CANVAS_HEIGHT);
        controller.game.scaleX = controller.game.scaleY = iScale*2;  
    }else if(s_bMobile || isChrome()){
        $("#canvas").css("width",destW+"px");
        $("#canvas").css("height",destH+"px");
    }else{
        controller.game.canvas.width = destW;
        controller.game.canvas.height = destH;

        s_iScaleFactor = Math.min(destW / CANVAS_WIDTH, destH / CANVAS_HEIGHT);
        controller.game.scaleX = controller.game.scaleY = s_iScaleFactor; 
    }
